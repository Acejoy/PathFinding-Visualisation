...
class DFS:
    ...
    def search(self, cur_coordinate, visitedPixel):
        ...
        if (cur_x, cur_y) == (self.end_x, self.end_y):
            ...
            if  not (cur_x -1, cur_y) in self.visited and \
                ...
                visitedPixel.stamp()
                self.search((cur_x -1, cur_y), visitedPixel)
            ...
            if  not (cur_x, cur_y -1) in self.visited and \
                ...
                visitedPixel.goto(screen_x, screen_y)
                visitedPixel.stamp()
                self.search((cur_x, cur_y-1), visitedPixel)
...
if __name__ == '__main__':
    ...
    dfsvisual  = DFS(grids.grid1, wallBlock, startBlock, endBlock)
    dfsvisual.search((dfsvisual.start_x, dfsvisual.start_y),visitedBlock)
    dfsvisual.find_path(backtrackBlock)
